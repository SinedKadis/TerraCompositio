...
public class TCChestBoatEntity extends ChestBoat {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE = SynchedEntityData.defineId(TCChestBoatEntity.class, EntityDataSerializers.INT);
    ...
    public TCChestBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this(TCEntities.TC_CHEST_BOAT.get(), pLevel);
    ...
    public @NotNull Item getDropItem() {
        if (Objects.requireNonNull(getModVariant()) == TCBoatEntity.Type.FLOW_CEDAR) {
