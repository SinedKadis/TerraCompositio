package net.sinedkadis.terracompositio.entity.animations;// Save this class in your mod and generate all required imports
 ...
 * @author SinedKadis
 */
public class FlowCedarEntAnimations {
	public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(4.5F).looping()
			...
			.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.0F, -0.75F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(2.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.75F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(3.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.75F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
		...
		.addAnimation("front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("back_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("back_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition EXTRACTION_COMPLETE = AnimationDefinition.Builder.withLength(2.0F)
			...
			.build();
	public static final AnimationDefinition ECF_HOLD = AnimationDefinition.Builder.withLength(0.25F).looping()
			.addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-180.0F, 0.0F, 10.0F), AnimationChannel.Interpolations.LINEAR),
