...
public class FluidRenderer {
    ...
    public static void renderScaledCuboid(PoseStack matrices, MultiBufferSource buffer, FluidCuboid cube, FluidStack fluid, float offset, int capacity, int light, boolean flipGas) {
        ...
        // draw cuboid
        renderCuboid(matrices, buffer.getBuffer(FLUID), cube, still, flowing, from, to, color, light, isGas);
    }
    /**
     * Render type used for the fluid renderer
     */
    public static final RenderType FLUID = RenderType.create(
            TerraCompositio.MOD_ID + ":block_render_type",
    ...
    public static class Baked extends InvBaked {
        @Getter
    ...
    public static class InvBaked extends BakedModelWrapper<BakedModel> {
        @Getter
        private final List<ModelItem> items;
        public InvBaked(BakedModel originalModel, List<ModelItem> items) {
            super(originalModel);
            this.items = items;
        }
    }
