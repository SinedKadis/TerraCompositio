...
public class UnstableTechnetiumItem extends Item implements ICFEStorageExtension {
    private final int radiation;
    private final ICFEStorageExtension storageExt;

    public UnstableTechnetiumItem(Properties pProperties, int radiation, ICFEStorageExtension storageExt) {
        super(pProperties);
